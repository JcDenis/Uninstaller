...
L10n::$locales['Preferences']                                           = 'Préférences';
L10n::$locales['Users preferences workspaces']                          = 'Préférences utilisateurs (workspaces)';
L10n::$locales['delete selected global preferences workspaces']         = 'effacer les préférences globales';
L10n::$locales['delete "%s" global preferences workspace']              = 'effacer les préférences globales "%s"';
L10n::$locales['"%s" global preferences workspace deleted']             = 'préférences globales "%s" effacées';
L10n::$locales['Failed to delete "%s" global preferences workspace']    = 'Impossible d\'effacer les préférences globales "%s"';
L10n::$locales['delete selected users preferences workspaces']          = 'effacer les préférences utilisateurs sélectionnées';
L10n::$locales['delete "%s" users preferences workspace']               = 'effacer les préférences utilisateurs "%s"';
L10n::$locales['"%s" users preferences workspace deleted']              = 'préférences utilistateurs "%s" effacées';
L10n::$locales['Failed to delete "%s" users preferences workspace']     = 'Impossible d\'effacer les préférences utilisateurs "%s"';
L10n::$locales['delete selected preferences workspaces']                = 'effacer les préférences selectionnées';
L10n::$locales['delete "%s" preferences workspace']                     = 'effacer les préférences "%s"';
L10n::$locales['"%s" preferences workspace deleted']                    = 'préférences "%s" effacées';
L10n::$locales['Failed to delete "%s" preferences workspace']           = 'Impossible d\'effacer les préférences "%s"';
L10n::$locales['delete related preferences']                            = 'effacer les préférences associées';
L10n::$locales['related preferences deleted']                           = 'préférences associées effacées';
L10n::$locales['Failed to delete related preferences']                  = 'Impossible d\'effacer les préférences associées';
